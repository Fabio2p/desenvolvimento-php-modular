...
class Controller{
	...
	protected function view($path, $view, $dados = null){
		...
		$path = $_SERVER['DOCUMENT_ROOT'] ."/application/Modules{$path}/views/".$view.'.view.php';
	...
	protected function model($path, $model){
		...
		$dir_model = $_SERVER['DOCUMENT_ROOT']."/application/Modules{$path}/models/".$model.'.class.php';
